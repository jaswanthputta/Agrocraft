...
<table class="tab">
    ...
    <tbody>
        ...
        ?>
                <tr class="trow">
                    <td class="center"><?php echo htmlspecialchars($farmer_name); ?></td>
                    <td class="center"><?php echo htmlspecialchars($farmer_phone); ?></td>
                    <td class="center"><?php echo htmlspecialchars($address); ?></td>
                    <td class="center"><?php echo htmlspecialchars($title); ?></td>
                    <td class="center"><?php echo htmlspecialchars($qty); ?></td>
                    <td class="center"><?php echo htmlspecialchars($deliveryMode); ?></td>
                    <td class="center"><?php echo htmlspecialchars($payment); ?></td>
                    <td class="center"><?php echo htmlspecialchars($amount); ?></td>
                </tr>
        <?php
            }
        }
...
<style>
    ...
    .thy {
        background-color: #f2f2f2; /* Optional: for header background */
