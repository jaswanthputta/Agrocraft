...
function getCropsHomepage() {
    ...
    global $conn; // Use your existing connection variable
    $query = "SELECT * FROM crops"; // Adjust based on your database schema
    ...
    while ($row = mysqli_fetch_assoc($result)) {
        // Assuming your crops table has 'id', 'name', and 'image_path' fields
        echo "<div class='crop'>";
        echo "<a href='../BuyerPortal/BuyerProductDetails.php?id=" . $row['id'] . "'>";
        echo "<img src='" . $row['image_path'] . "' alt='" . $row['name'] . "' style='width:300px; height:200px;'>";
        echo "<p>" . $row['name'] . "</p>";
        echo "</a>";
        echo "</div>";
    }
